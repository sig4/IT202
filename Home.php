...
<head></head>
<body>
<br> To fully get an indept report of the accident get reports from the two drivers in the accident<br>
 Once that is complete, fill out your own questionaire to record your own observations
		...
		<input type="button" onclick="window.location.href = 'https://web.njit.edu/~sig4/IT202/customerReg.php';" value ="Driver1 QUESTIONAIRE"/>
                <input type="button" onclick="window.location.href = 'https://web.njit.edu/~sig4/IT202/customerReg.php';" value ="Driver2 QUESTIONAIRE"/>
