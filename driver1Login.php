...
<body>
	...
	Password: 	<input type="password" name="password"/><br>
		...
		<input type="button" onclick="window.location.href = 'https://web.njit.edu/~sig4/IT202/regDriver.php';" value="Register as new CUSTOMER"/>
		<input type="button" onclick="window.location.href = 'https://web.njit.edu/~sig4/IT202/Home.php';" value="GO BACK TO HOME"/>
	</form>
</body>
</html>
<?php
